...
def iceberg_setup(account_id: str) -> None:
    ...
    upload_file_s3_bucket(glue_iceberg_job_path, bucket_key, bucket_name)
    ...
    for table in table_list:
        ...
        job_run_id = run_glue_job(glue_iceberg_job, glue_database, source_path, glue_database, table, iceberg_bucket)
